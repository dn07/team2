...
<center><h3><font face = "Verdana" size = "6">Customer Login</font></h3></center>
<center>
...
LOAN ID:<br/><input type="text" name="Loan_id"/>
<br/>
PASSWORD:<br/><input type="password" name="pwd"/>
<br/>
<a href="Form_Customer.jsp"><button type="button" style="background-color: oldlace; border-radius: 50px;width: 200px;height:30px;">Log In</button></a>
